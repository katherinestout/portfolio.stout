...
<div className = "wrapper-1">
   ...
   <div className = "">
        For each of the four pages, we provided 
        an explanation of the particular part of Medicare,
        including a finances and services overview. 
        We also explained what data we had been
        analyzing and what the (future) data 
        visualization tool would display.
   </div>
   ...
   <div className = "">
   A thought provoking fact regarding questionable spending gaps.
   </div>
   <div className = "">
   IMAGE
   </div>
   ...
   <div className = "">
   A table displaying total spending facts/ figures for a particular year.
   </div>
   <div className = "">
   IMAGE
   </div>
