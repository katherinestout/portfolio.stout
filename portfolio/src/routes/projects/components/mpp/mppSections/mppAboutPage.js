...
<div className="mppContainer">
    ...
    <div className = "wrapper-2">
                ...
                <div className = "image div2"> <img src={about1} alt="about1" className="about1"/></div>
                <div className = "image div3"> <img src={about2} alt="about2" className="about2"/></div>
                <div className = "image div4"> <img src={about3} alt="about3" className="about3"/></div>
...
<div className = "wrapper-3">
        ...
        <div className = "image div4"> <img src={ff4} alt="ff4" className="ff4"/></div>
            ...
            <div className = "">
            A main graphic to represent the four parts of Medicare

            </div>
            <div className = "image"> <img src={about8} alt="about8" className="about8"/></div>
            <div className = "">
            Icons to break up the five sections of content
            </div>
            <div className = "image"> <img src={about9} alt="about9" className="about9"/></div>
            <div className = "image"> <img src={about10} alt="about10" className="about10"/></div>
